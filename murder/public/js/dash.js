...
app.controller('dashController', function ($scope, $mdToast, $http, $animate) {
    ...
    var engRules = 'You can attempt to kill your assigned victim by handing them an object and <b>directly afterwards</b> making the attempt public.<br>The requirements for an attempt to be successful are as follows:<br><ul> <li>The victim must accept the object voluntarily.</li><li>The attempt must not be directly witnessed by any other living player.</li></ul>Should an attempt be successful, it is the victim\'s duty to indicate on this website that they have been killed and add a death message describing the murder in a creative and funny fashion (e.g. a pun including the object - or killing tool - they have been slain with).<br>Your new job is then to kill the victim of your previously slain victim - you will find their name on this website as soon as your last victim indicates their death!<br>All deaths, including their time, location and posted death message will be made visible to every player in their dashboard.<br>To clarify, please note:<ul> <li> As long as not made public by yourself, any handing over of objects will not be affected by these rules. It is a common strategy for players to deceive their victims by handing them objects in silence several times before making an actual murder attempt. </li> <li> Players are classified \'living\' (and thus able to testify as a witness) if and only if they are both participating in the game and have not been killed yet. </li> <li> It is acceptable for other living players to be present during a successful attempt to murder your victim, as long as they do not observe the handing over of your killing tool, for example because they were inattentive or distracted. </li></ul> <br> Should there remain any questions unanswered, please do not hesitate to approach Marco.';
    var gerRules = 'Du kannst deinen Mordauftrag ausfüllen, indem du deinem Opfer einen beliebigen Gegenstand überreichst und <b>direkt anschließend</b> die Übergabe als einen Mordversuch erklärst.<br>Damit ein Mordversuch erfolgreich ist und der Mordauftrag ausgefüllt wird, muss Folgendes gegeben sein:<ul> <li> Das Opfer muss den Gegenstand freiwillig angenommen haben. </li> <li> Der Mordversuch darf nicht von einem anderen lebenden Spieler wahrgenommen werden. </li></ul><br>Sollest du dein Opfer erfolgreich getötet haben, muss dein Opfer auf dieser Website angeben, dass es gestorben ist und eine kreative sowie witzige Todesnachricht eingeben (z.B. ein Flachwitz mit dem überreichten Mordwerkzeug).<br>Dein neuer Auftrag ist nun der Auftrag von deinem bereits getöteten Opfer. Du siehst ihn in deinem Dashboard, sobald dein "altes Opfer" sich als ermordet einträgt!<br>Alle Tode werden mit der Zeit, dem Ort und der angegebenen Todesnachricht auf dem für alle Spieler sichtbaren Dashboard veröffentlicht.<br>Damit keine Missverständnisse auftreten:<ul> <li> Solange du das Überreichen eines Gegenstandes nicht laut für einen Mordversuch erklärst, treffen diese Regeln nicht auf die Übergabe zu. Eine typische Strategie ist, seinem Opfer mehrere Gegenstände zu übergeben ohne etwas zu sagen, um dieses zu trügen. </li> <li> Spieler gelten nur dann als lebend (und sind nur dann im Stande als Zeuge einen Mord wahrzunehmen), wenn sie einerseits am Spiel teilnehmen und andererseits noch nicht getötet wurden. </li> <li> Ein Mord kann auch erfolgreich ablaufen, wenn während der Übergabe andere lebende Spieler anwesend sind, welche den Mordversuch nicht direkt beobachten, weil sie z.B. nicht aufmerksam oder abgelenkt sind. </li></ul>Du hast noch Fragen? Bitte wende dich an Marco.';
